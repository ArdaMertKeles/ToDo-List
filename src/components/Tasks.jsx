...
function Tasks({click,remove,task}) {
    ...
    return (
        <div className="taskContainer">
            <form className="taskInput" >
                <input type="checkbox" name="checked" id="checked"  onClick={click}
                 onChange={() => setCheckbox(checkbox => !checkbox)} />
                <input type="text" className={checkbox ? 'checkedTaskValue' : 'taskValue'} name="task" id="task" disabled value={task} />
            </form>
